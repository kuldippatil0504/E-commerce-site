...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen bg-background flex flex-col md:flex-row-reverse">
      {/* Right side - Image */}
      <div className="hidden md:block md:w-1/2 relative bg-secondary">
        ...
        >
          <source src="https://cdn.coverr.co/videos/coverr-fashion-model-posing-5246/1080p.mp4" type="video/mp4" />
        </video>
        <div className="absolute inset-0 z-20 flex flex-col justify-between p-12 text-white">
          ...
          <div className="text-right">
            <h2 className="text-4xl font-bold mb-4 max-w-md ml-auto leading-tight">Join the exclusive club.</h2>
            <p className="text-white/80">Create an account to save your wishlist and access member-only sales.</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-16 lg:px-24 xl:px-32 relative">
        ...
        >
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-foreground/60">Enter your details below to create your account.</p>
          </div>
